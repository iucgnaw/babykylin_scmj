...
New-NetFirewallRule -DisplayName "ChangHuaMahjong Client on Cocos Creator (TCP-In 7456)" -Direction Inbound -LocalPort 7456 -RemotePort Any -Protocol TCP -Enabled True
New-NetFirewallRule -DisplayName "ChangHuaMahjong Client on IIS (TCP-In 1111)" -Direction Inbound -LocalPort 1111 -RemotePort Any -Protocol TCP -Enabled True
